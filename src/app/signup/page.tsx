  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <p className="text-slate-500 text-center mb-8 text-sm">Track your university applications</p>
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <Link href="/login" className="text-purple-600 hover:underline font-medium">Log in</Link>
        </p>
